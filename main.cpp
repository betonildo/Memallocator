...
int main(int argc, char** argv) {	
	...
	// Simple reallocation Free space at the end
	U64** u64array = h.allocateArray<U64>(3);	
	u64array = h.reallocate<U64>(u64array, sizeof(U64) * 5);
	memset(*u64array, 100, sizeof(U64) * 5);
	h.printTilNext();

	// Simple reallocation, don't have free space, but reallocate at the end
	U64** u64array2 = h.allocateArray<U64>(3);
	U64** u64array3 = h.allocateArray<U64>(3);
	memset(*u64array3, 103, sizeof(U64) * 5);
	u64array2 = h.reallocate<U64>(u64array2, sizeof(U64) * 5);
	memset(*u64array2, 102, sizeof(U64) * 5);
	h.printTilNext();

	// Search for new reallocation on the next freed space
	u64array = h.reallocate<U64>(u64array, sizeof(U64) * 8);	
	memset(*u64array, 100, sizeof(U64) * 10);
	h.printTilNext();	
